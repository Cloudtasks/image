...
[![Codacy Badge](https://api.codacy.com/project/badge/Grade/606abf5220d94f4f80e94f6c850a6fab)](https://www.codacy.com/app/jonnybgod/image?utm_source=github.com&amp;utm_medium=referral&amp;utm_content=Cloudtasks/image&amp;utm_campaign=Badge_Grade)
...
[![devDependency Status](https://david-dm.org/Cloudtasks/image/dev-status.svg)](https://david-dm.org/Cloudtasks/image#info=devDependencies)

[![Github Releases](https://img.shields.io/github/downloads/Cloudtasks/image/latest/total.svg)]()
...
<script defer src="https://cdn.jsdelivr.net/gh/Cloudtasks/image@3/dist/cloudtasks-image.js"></script>
```
...
[npm-url]: https://npmjs.org/package/@cloudtasks/image
[npm-image]: https://badge.fury.io/js/image.svg
[travis-url]: https://travis-ci.org/Cloudtasks/image
[travis-image]: https://travis-ci.org/Cloudtasks/image.svg?branch=master
